...
1. A method, `public void removeLastAdded()`, which deletes the *last added* grade (it's not necessarily at the end of the list) from this gradebook. If there are no grades (`this.head == null`), it does nothing.
