...
Start a new BlueJ project named **hw290-freqtable**. This is the first step of an extended project in which you will implement a classic compression/decompression algorithm.
